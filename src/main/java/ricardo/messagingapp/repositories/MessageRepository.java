...
public class MessageRepository {
    ...
    public List<UUID> findAllUsersWithConversationWithUser(UUID userId) {
        ...
        return jdbcTemplate.query(sql, new Object[]{userId, userId, userId}, (rs, rowNum) -> (UUID) rs.getObject("user_id"));
    }
    ...
    public List<UUID> findLatestConversations(UUID userId, int limit) {
        ...
        return jdbcTemplate.query(sql, new Object[]{userId, userId, limit}, (rs, rowNum) -> (UUID) rs.getObject("conversation_id"));
    }
    ...
    public List<Username> findLatestConversationNames(UUID userId, int limit) {
        String sql = "SELECT DISTINCT c.name FROM conversations c " +
